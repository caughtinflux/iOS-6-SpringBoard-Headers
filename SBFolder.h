...
@class SBFolderIcon, SBIconIndexMutableList;
...
- (NSString *)nodeDescriptionWithPrefix:(NSString *)prefix;
...
- (NSIndexPath *)indexPathForFirstFreeSlotAvoidingFirstList:(BOOL)arg1;
- (id)performCascadingIconInsertion:(id)arg1 listIndex:(NSUInteger)arg2 iconIndex:(NSUInteger)arg3 addPageIfNecessary:(BOOL)arg4;
- (BOOL)canAddIcon;
- (id)addIcon:(id)arg1;
